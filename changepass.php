...
<div id="Leftnavv">
	...
	<div id="Rightnavv"> </div>
            <div id="fullBody"> 
                <div class="loginBody">
                    <form class="form-signin" align ="center" name="changePassword" action="changepass2.php" method="POST">
                        
                        <h1 class="h3 mb-3 font-weight-normal">Change Password</h1>
                        
                        <input type="text" name="username" class="form-control" placeholder="user name" required autofocus><br><br>
                        <br>
                        <input type="password" name="newpass" class="form-control" placeholder="New Password" required><br><br>
                        <input type="password" name="newpass2" class="form-control" placeholder="Confirm New Password" required><br><br>
